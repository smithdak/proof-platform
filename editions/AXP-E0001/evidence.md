...
|---|---|---|---|---|
| Edition structure | `rtk scripts/swarm.sh validate AXP-E0001` | valid | revised sixteen-task W1-W13 graph passed after the E0001-16 archive repair; edition diff check clean on 2026-08-30 | passed |
...
| CLI impact | `rtk scripts/test-scoped.sh proof-transport-cli`; post-repair complete host replay | CLI passes with preflight-before-secret tests | historical final rerun passed 68 plus 11 child tests; current complete host replay passes 78/78 across two suites after all three authority/archive repairs | passed |
