...
|---|---|---|---|---|
| Edition structure | `rtk scripts/swarm.sh validate AXP-E0001` | valid | revised seventeen-task W1-W14 graph passed after the E0001-17 identity repair; edition diff check clean on 2026-08-30 | passed |
...
| CLI impact | `rtk scripts/test-scoped.sh proof-transport-cli`; post-repair complete host replay | CLI passes with preflight-before-secret tests | historical final rerun passed 68 plus 11 child tests; current complete host replay passes 81/81 across two suites after all four authority/archive/identity repairs | passed |
...
| Post-repair readiness replay | host `live-prepare finish` with both provider variables unset after E0001-14..17 | exact retained 10/10 evidence, bindings, `next_argv`, and binding digest; no provider boundary | exact packet and digest `7efebe8d98ad23f9a122ae64f76887d371804f719bae7fb4a69b434e511b6b71` returned after final source; ready record remains mode `0600` under workspace mode `0700`; zero provider attempt | passed |
